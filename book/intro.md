...
A bug in the accounting logic raises `ValueError` immediately — not silently wrong numbers.
...
- **Architecture** — Lean kernel ↔ Python ↔ Cython FFI
- **Human–AI Collaboration** — how Lean acts as a development scaffold constraining AI-generated code

## References

- Hull, *Options, Futures, and Other Derivatives*, 12th ed. — Tables 19.2, 19.3
